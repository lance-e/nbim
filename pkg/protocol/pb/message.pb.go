...
type LoginMsg struct {
	...
	LoginBody     []byte                 `protobuf:"bytes,2,opt,name=login_body,json=loginBody,proto3" json:"login_body,omitempty"` //有效负载
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type UplinkMsg struct {
	...
	UplinkBody    []byte                 `protobuf:"bytes,3,opt,name=uplink_body,json=uplinkBody,proto3" json:"uplink_body,omitempty"` //有效负载
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UplinkMsg) GetSessionId() int64 {
	if x != nil {
		return x.SessionId
	}
	return 0
...
type DownlinkMsg struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	MessageId     int64                  `protobuf:"varint,1,opt,name=message_id,json=messageId,proto3" json:"message_id,omitempty"`         //最后一条消息id
	SessionId     int64                  `protobuf:"varint,2,opt,name=session_id,json=sessionId,proto3" json:"session_id,omitempty"`         //会话id
	DownlinkBody  []byte                 `protobuf:"bytes,3,opt,name=downlink_body,json=downlinkBody,proto3" json:"downlink_body,omitempty"` //有效负载
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *DownlinkMsg) GetMessageId() int64 {
	if x != nil {
		return x.MessageId
	}
	return 0
...
func (x *DownlinkMsg) GetSessionId() int64 {
	if x != nil {
		return x.SessionId
	}
	return 0
...
type AckMsg struct {
	...
	ConnId        int64                  `protobuf:"varint,4,opt,name=conn_id,json=connId,proto3" json:"conn_id,omitempty"`          //连接id
	ClientId      int64                  `protobuf:"varint,5,opt,name=client_id,json=clientId,proto3" json:"client_id,omitempty"`    //局部消息序列号
	SessionId     int64                  `protobuf:"varint,6,opt,name=session_id,json=sessionId,proto3" json:"session_id,omitempty"` //会话id
	MessageId     int64                  `protobuf:"varint,7,opt,name=message_id,json=messageId,proto3" json:"message_id,omitempty"` //最后一条消息id
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var file_message_proto_rawDesc = string([]byte{
	...
	0x22, 0x46, 0x0a, 0x08, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x4d, 0x73, 0x67, 0x12, 0x1b, 0x0a, 0x09,
	0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52,
	0x08, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x49, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x6c, 0x6f, 0x67,
	0x69, 0x6e, 0x5f, 0x62, 0x6f, 0x64, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x09, 0x6c,
	0x6f, 0x67, 0x69, 0x6e, 0x42, 0x6f, 0x64, 0x79, 0x22, 0x68, 0x0a, 0x09, 0x55, 0x70, 0x6c, 0x69,
	0x6e, 0x6b, 0x4d, 0x73, 0x67, 0x12, 0x1b, 0x0a, 0x09, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x5f,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0a, 0x75, 0x70, 0x6c, 0x69, 0x6e, 0x6b, 0x42, 0x6f,
	0x64, 0x79, 0x22, 0x70, 0x0a, 0x0b, 0x44, 0x6f, 0x77, 0x6e, 0x6c, 0x69, 0x6e, 0x6b, 0x4d, 0x73,
	0x67, 0x12, 0x1d, 0x0a, 0x0a, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x5f, 0x69, 0x64, 0x18,
	...
	,
	...
	0x07, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x49, 0x64,
	0x2a, 0x4e, 0x0a, 0x03, 0x43, 0x4d, 0x44, 0x12, 0x09, 0x0a, 0x05, 0x4c, 0x6f, 0x67, 0x69, 0x6e,
	0x10, 0x00, 0x12, 0x0a, 0x0a, 0x06, 0x55, 0x70, 0x6c, 0x69, 0x6e, 0x6b, 0x10, 0x01, 0x12, 0x0c,
	0x0a, 0x08, 0x44, 0x6f, 0x77, 0x6e, 0x6c, 0x69, 0x6e, 0x6b, 0x10, 0x02, 0x12, 0x0d, 0x0a, 0x09,
	0x48, 0x65, 0x61, 0x72, 0x74, 0x62, 0x65, 0x61, 0x74, 0x10, 0x03, 0x12, 0x0a, 0x0a, 0x06, 0x52,
	0x65, 0x63, 0x6f, 0x6e, 0x6e, 0x10, 0x04, 0x12, 0x07, 0x0a, 0x03, 0x41, 0x63, 0x6b, 0x10, 0x05,
	0x42, 0x11, 0x5a, 0x0f, 0x70, 0x6b, 0x67, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c,
